...
// defaultTenant HTTP API 使用的默认租户，保持向后兼容
var defaultTenant = TenantContext{TenantID: "default", AppID: "default"}
...
func (s *AppServer) checkLoginStatusHandler(c *gin.Context) {
	status, err := s.xiaohongshuService.CheckLoginStatus(c.Request.Context(), defaultTenant)
	if err != nil {
...
func (s *AppServer) getLoginQrcodeHandler(c *gin.Context) {
	result, err := s.xiaohongshuService.GetLoginQrcode(c.Request.Context(), defaultTenant)
	if err != nil {
		respondError(c, http.StatusInternalServerError, "STATUS_CHECK_FAILED",
			"获取登录二维码失败", err.Error())
		return
...
func (s *AppServer) deleteCookiesHandler(c *gin.Context) {
	err := s.xiaohongshuService.DeleteCookies(c.Request.Context(), defaultTenant)
	if err != nil {
	...
	cookiePath := defaultTenant.CookiesFilePath()
...
func (s *AppServer) publishHandler(c *gin.Context) {
	...
	result, err := s.xiaohongshuService.PublishContent(c.Request.Context(), defaultTenant, &req)
	if err != nil {
...
func (s *AppServer) publishVideoHandler(c *gin.Context) {
	...
	result, err := s.xiaohongshuService.PublishVideo(c.Request.Context(), defaultTenant, &req)
	if err != nil {
...
func (s *AppServer) listFeedsHandler(c *gin.Context) {
	result, err := s.xiaohongshuService.ListFeeds(c.Request.Context(), defaultTenant)
	if err != nil {
...
func (s *AppServer) searchFeedsHandler(c *gin.Context) {
	...
	result, err := s.xiaohongshuService.SearchFeeds(c.Request.Context(), defaultTenant, keyword, filters)
	if err != nil {
...
func (s *AppServer) getFeedDetailHandler(c *gin.Context) {
	...
	if req.CommentConfig != nil {
		...
		result, err = s.xiaohongshuService.GetFeedDetailWithConfig(c.Request.Context(), defaultTenant, req.FeedID, req.XsecToken, req.LoadAllComments, config)
	} else {
		result, err = s.xiaohongshuService.GetFeedDetail(c.Request.Context(), defaultTenant, req.FeedID, req.XsecToken, req.LoadAllComments)
	}
...
func (s *AppServer) userProfileHandler(c *gin.Context) {
	...
	result, err := s.xiaohongshuService.UserProfile(c.Request.Context(), defaultTenant, req.UserID, req.XsecToken)
	if err != nil {
...
func (s *AppServer) postCommentHandler(c *gin.Context) {
	...
	result, err := s.xiaohongshuService.PostCommentToFeed(c.Request.Context(), defaultTenant, req.FeedID, req.XsecToken, req.Content)
	if err != nil {
...
func (s *AppServer) replyCommentHandler(c *gin.Context) {
	...
	result, err := s.xiaohongshuService.ReplyCommentToFeed(c.Request.Context(), defaultTenant, req.FeedID, req.XsecToken, req.CommentID, req.UserID, req.Content)
	if err != nil {
...
func (s *AppServer) myProfileHandler(c *gin.Context) {
	result, err := s.xiaohongshuService.GetMyProfile(c.Request.Context(), defaultTenant)
	if err != nil {
