...
type HotSearch struct {
	...
	Heat    string `json:"heat,omitempty"`    // 热度值
	Label   string `json:"label,omitempty"`   // 标签（如：热、新）
...
type Topic struct {
	...
	PostCount   string `json:"post_count,omitempty"`  // 参与人数
	CoverURL    string `json:"cover_url,omitempty"`
	IsHot       bool   `json:"is_hot"`
}

// TrendingResponse 热点响应
type TrendingResponse struct {
	HotSearches []HotSearch `json:"hot_searches"` // 热搜列表
